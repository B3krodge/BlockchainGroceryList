...
Click your profile icon (top-right) → Settings → Networks → Add a network.
...
Click the 🔑 (key) icon next to any account to copy its private key.
In MetaMask, click the account icon (top-right) → Import account.
